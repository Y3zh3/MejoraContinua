        ...
        <Card>
            ...
            <CardContent className="flex flex-col gap-4 pt-6">
                ...
                <div className="mt-2">
                    ...
                    <p className="text-sm text-muted-foreground">El rendimiento del contratista es consistentemente alto y cumple con la meta establecida. La gestión y ejecución son adecuadas.</p>
                </div>
            </CardContent>
        </Card>
      </div>
