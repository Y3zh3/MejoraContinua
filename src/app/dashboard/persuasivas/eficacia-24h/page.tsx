...
export default function Eficacia24hPersuasivasPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto flex flex-col gap-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <Card className="transition-colors hover:bg-primary/10">
            ...
            <ResponsiveContainer width="100%" height="100%">
                ...
                />
                <Legend />
                <Bar dataKey="value" name="Eficacia" fill="hsl(var(--chart-2))" radius={[4, 4, 0, 0]} />
        ...
        <Card className="transition-colors hover:bg-primary/10">
            ...
            <CardContent className="flex flex-col gap-4 pt-6">
                ...
                <div className="mt-2">
                    ...
                    <p className="text-base text-muted-foreground">La eficacia a 24 horas muestra una tendencia positiva y se acerca a la meta. Se deben reforzar las acciones para asegurar el cumplimiento.</p>
                </div>
            </CardContent>
        </Card>
      </div>
      <Card className="transition-colors hover:bg-primary/10">
        <CardHeader>
          <CardTitle>Detalle Semanal de Eficacia 24H</CardTitle>
          <p className="text-base text-muted-foreground">
            Desglose de la eficacia en 24 horas por semana.
          </p>
        </CardHeader>
        <CardContent>
