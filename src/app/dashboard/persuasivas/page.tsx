        ...
        <div className="flex flex-col gap-6">
            <div className="flex flex-wrap items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="font-headline text-3xl font-bold">Módulo de Acciones Persuasivas</h1>
                        <p className="text-muted-foreground">Medición de eficacia y eficiencia de la cobranza.</p>
                    </div>
                </div>
