  ...
  return (
    <div className="max-w-7xl mx-auto flex flex-col gap-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <Card className="transition-colors hover:bg-primary/10">
            ...
            <CardContent className="flex flex-col gap-4 pt-6">
                ...
                <div className="mt-2">
                    ...
                    <p className="text-base text-muted-foreground">La eficiencia ha mejorado a lo largo del mes, superando la meta en la última semana. Se debe mantener la estrategia actual.</p>
                </div>
            </CardContent>
        </Card>
      </div>
       ...
       <Card className="transition-colors hover:bg-primary/10">
        <CardHeader>
          <CardTitle>Detalle Semanal de Eficiencia</CardTitle>
          <p className="text-base text-muted-foreground">
            Desglose de la eficiencia en acciones persuasivas por semana.
          </p>
        </CardHeader>
        <CardContent>
