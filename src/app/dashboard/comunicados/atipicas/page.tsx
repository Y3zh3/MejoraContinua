        ...
        <Card>
            ...
            <CardContent className="flex flex-col gap-4 pt-6">
                ...
                <div className="mt-2">
                    ...
                    <p className="text-sm text-muted-foreground">El número de comunicaciones atípicas ha fluctuado durante el mes, superando la meta en algunas semanas. Se requiere un análisis más profundo para determinar las causas raíz.</p>
                </div>
            </CardContent>
        </Card>
      </div>
