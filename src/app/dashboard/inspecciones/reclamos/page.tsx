        ...
        <Card>
            ...
            <CardContent className="flex flex-col gap-4 pt-6">
                ...
                <div className="mt-2">
                    ...
                    <p className="text-sm text-muted-foreground">El número de reclamos se ha mantenido por debajo de la meta, lo cual es positivo. Se debe continuar con las buenas prácticas para mantener esta tendencia.</p>
                </div>
            </CardContent>
        </Card>
      </div>
